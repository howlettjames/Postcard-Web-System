<?php
    ...
    if(isset($_SESSION["correo"])){
        include("./main_BD.php");
        $sqlPostales = "SELECT * FROM bandeja_salida WHERE correo = '$correo'";
        $postales = array();    
...
<title>WORM BANDEJA SALIDA</title>
                            ...
                            '<div class="col s12 m4">
                                <div class="card">
                                    ...
                                    <div class="card-content">
                                        ...
                                        <span class="card-title activator"><strong>Enviado a: '.$postal[2].'</strong><i class="material-icons right">more_vert</i></span>
                                        <p>'.$postal[1].'</p>
                                        <p>Fecha envio: '.$postal[6].'</p>
                                    </div>
